...
const cards = [1, 2, 3];
const desc = ["Interactive and multi-language supported code editor which allows multiple developers to code at once and debug each other's code", "Real-time collaborative text editor which allows multiple people of the same party to edit, create and manipulate documents on the cloud", "Documents on the cloud can be accessed by the collaborators from any part of the world"];
              ...
              <Grid item key={card} xs={12} sm={6} md={4}>
                <Card className={classes.card}>
                  <CardMedia
                    ...
                    image={logos[i]} style={{width: "50%", marginLeft: "3.5rem"}}
                  />
